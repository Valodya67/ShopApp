...
namespace ShopApp.WebUI.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        private Payment PaymentProcess(OrderModel model)
        {
            ...
            options.ApiKey = "sandbox-MkIkAkATpXYeZxmnuMlA4JylkgFOgXL9";
            options.SecretKey = "sandbox-oGozssuunNx2PVt02d12cuAaz8Q6LZPw";
            ...
            foreach (var item in model.CartModel.CartItems)
            {
                ...
                basketItem.Price = item.Price.ToString().Split(",")[0]; basketItems.Add(basketItem);
            }
        ...
        public IActionResult GetOrders()
        {
            ...
            foreach (var order in orders)
            {
                ...
                orderModel.FirstName = order.FirstName; orderModel.LastName = order.LastName; orderModel.Email = order.Email; orderModel.Address = order.Address;
